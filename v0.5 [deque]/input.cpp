...
void skaityti_is_failo( deque<Studentas> &studentas ) {
    try {
...
void skaityti_is_ivesties( deque<Studentas> &studentas ) {
    Studentas s;
    char ans;
...
void read_data( deque<Studentas> &studentas ) {
    char ans;
